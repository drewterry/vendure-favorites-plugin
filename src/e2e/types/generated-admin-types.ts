...
export namespace GetCustomer {
  ...
  export type History = (NonNullable<GetCustomerQuery['customer']>)['history'];
  export type Items = (NonNullable<(NonNullable<GetCustomerQuery['customer']>)['history']['items'][0]>);
}

export type GetCustomerFavoritesQueryVariables = Exact<{
  customerId: Scalars['ID'];
}>;

...
export namespace GetOwnFavorites {
  export type Variables = GetOwnFavoritesQueryVariables;
  export type Query = GetOwnFavoritesQuery;
  export type ActiveCustomer = (NonNullable<GetOwnFavoritesQuery['activeCustomer']>);
  export type Favorites = (NonNullable<GetOwnFavoritesQuery['activeCustomer']>)['favorites'];
  export type Items = (NonNullable<(NonNullable<GetOwnFavoritesQuery['activeCustomer']>)['favorites']['items'][0]>);
  export type Product = (NonNullable<(NonNullable<(NonNullable<GetOwnFavoritesQuery['activeCustomer']>)['favorites']['items'][0]>)['product']>);
}
...
export namespace ToggleFavorite {
  ...
  export type ToggleFavorite = ToggleFavoriteMutation['toggleFavorite'];
  export type Items = (NonNullable<ToggleFavoriteMutation['toggleFavorite']['items'][0]>);
